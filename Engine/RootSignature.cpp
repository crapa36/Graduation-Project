...
void RootSignature::CreateGraphicsRootSignature() {
    ...
    {
        CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_CBV, CBV_REGISTER_COUNT - 1, 2), // b2~b4
        CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, SRV_REGISTER_COUNT, 0), // t0~t4
    };

    CD3DX12_ROOT_PARAMETER param[3];
    param[0].InitAsConstantBufferView(static_cast<uint32>(CBV_REGISTER::b0)); // b0
    param[1].InitAsConstantBufferView(static_cast<uint32>(CBV_REGISTER::b1)); // b1
