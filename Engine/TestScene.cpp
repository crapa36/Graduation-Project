...
#pragma region BIN
    {
        ...
        mainObject->AddComponent(make_shared<SphereCollider>());
        mainObject->AddComponent(make_shared<TestDragonScript>());
        mainObject->AddComponent(make_shared<Rigidbody>());
        dynamic_pointer_cast<SphereCollider>(mainObject->GetCollider())->SetRadius(50.f);
        dynamic_pointer_cast<SphereCollider>(mainObject->GetCollider())->SetCenter(Vec3(0.f, 10.f, 0.f));
