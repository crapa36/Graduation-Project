...
PatchTess ConstantHS(InputPatch<VS_OUT, 3> input, int patchID : SV_PrimitiveID)
{
    ...
    float edge0TessLevel = CalculateTesslationLevel(g_vec4_0.xyz, edge0Pos, minDistance, maxDistance, g_float_0);
    float edge1TessLevel = CalculateTesslationLevel(g_vec4_0.xyz, edge1Pos, minDistance, maxDistance, g_float_0);
    float edge2TessLevel = CalculateTesslationLevel(g_vec4_0.xyz, edge2Pos, minDistance, maxDistance, g_float_0);
